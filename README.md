...
You also need to choose which antennae the vessels in each orbit have. There a few vanilla ones, but you can also create your own custom antenna by choosing the "custom" option.
